...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-13 21:21:19 UTC<br>状态：成功</p>
</section>
...
<p>今日仅速读1篇论文，聚焦移动机器人的物理-地理空间场景理解（6.0/10）。该方向尝试把物理约束与地理空间信息结合用于场景解读，值得关注机器人如何在真实环境中落地感知。普通读者可留意这类&quot;感知+定位&quot;融合思路，但单篇分数中等，建议等更多验证再深入。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Physico-Geospatial Grounded Scene Interpretation for Mobile Robotics">Physico-Geospatial Grounded Scene Interpretation for Mobile Robotics</span></li></ul>
  </div>
